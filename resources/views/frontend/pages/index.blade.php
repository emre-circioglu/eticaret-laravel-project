         ...
         <div class="row align-items-start align-items-md-center justify-content-end">
             <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                 ...
                 <div class="intro-text text-center text-md-left">
                     ...
                     <p>
                         <a href="{{ url($slider->link) }}" class="btn btn-sm btn-primary">Ürünlere Git</a>
                     </p>
                 </div>
             </div>
         </div>
         ...
         <div class="row">
             <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
                 ...
                 <div class="text">
                     ...
                     <p>Ürünlerinizi ücretsiz kargoyla temin edebilirsiniz.</p>
                 </div>
             </div>
     ...
     <div class="container">
         ...
         <div class="row align-items-center">
             ...
             <div class="col-md-12 col-lg-5 text-center pl-md-5">
                 <h3>Tüm ürünlerimizde %50 indirim!</h3>
                 <p>Seçili ürünlerde indirim fırsatlarını kaçırmayın!</p>
                 <p><a href="{{ route('indirimliurunler') }}" class="btn btn-primary btn-sm">İndirimdeki Ürünler</a></p>
             </div>
         </div>
     </div>
 </div>
